...
export function FormHeader({
  ...
  const showMetaEditor = editingMeta && !systemManaged;
        ...
        <>
          ...
          <div className="min-w-0 flex-1">
            <div className="flex items-center gap-2">
              ...
              {systemManaged && (
                <span className="rounded-full border border-amber-500/30 bg-amber-500/10 px-2 py-0.5 text-[10px] font-bold tracking-wider text-amber-300 uppercase">
                  System
                </span>
              )}
            </div>
            ...
            {systemManaged && (
              <div className="text-xs text-amber-300/80">{systemManagementHint}</div>
            )}
          </div>
          {!systemManaged && (
            <>
