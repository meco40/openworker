        ...
        >
          ...
          <div className="flex-shrink-0">
            {session.agent_avatar_emoji ? (
              ...
              <Bot className="text-mc-accent h-8 w-8" />
            )}
          </div>
          ...
          <div className="min-w-0 flex-1">
            ...
            <div className="mb-1 flex items-center gap-2">
              ...
              <span className="text-mc-text font-medium">{session.agent_name || 'Sub-Agent'}</span>
              <span className="text-mc-text-secondary text-xs capitalize">{session.status}</span>
            </div>

            {/* Session ID */}
            <div className="text-mc-text-secondary mb-2 truncate font-mono text-xs">
              Session: {session.openclaw_session_id}
            </div>

            {/* Duration and timestamps */}
            <div className="text-mc-text-secondary flex items-center gap-3 text-xs">
          ...
          <div className="flex flex-col gap-1">
            {session.status === 'active' && (
              <button
                ...
                className="hover:bg-mc-bg-tertiary rounded p-1.5 text-green-500"
            ...
            <button
              ...
              className="hover:bg-mc-bg-tertiary rounded p-1.5 text-red-500"
