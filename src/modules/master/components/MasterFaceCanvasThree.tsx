...
import type { MasterAvatarAudioEvent, MasterAvatarAudioStream } from '../types';
...
const AVATAR_MODEL_URL = '/models/master-avatar-rigged.glb';
const CAMERA_BASE_Y = 1.2;
const CAMERA_LOOK_AT_Y = 1.1;
const AVATAR_BASE_Y = -0.75;
...
function getMoodByState(state: FaceState): string {
  switch (state) {
    case 'listening':
      return 'neutral';
    case 'thinking':
