  ...
  const agents = [
    {
      ...
      emoji: '💻',
      desc: 'Writes code, creates automations, handles technical tasks',
    },
    {
      name: 'Researcher',
      role: 'Research & Analysis',
      emoji: '🔍',
      desc: 'Gathers information, analyzes data, provides insights',
    },
    {
      name: 'Writer',
      role: 'Content & Documentation',
      emoji: '✍️',
      desc: 'Creates content, writes documentation, handles communications',
    },
    {
      name: 'Designer',
      role: 'Creative & Design',
      emoji: '🎨',
      desc: 'Handles visual design, UX decisions, creative work',
    },
  ];
