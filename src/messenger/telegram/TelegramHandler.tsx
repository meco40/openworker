  ...
  return (
    <div className="animate-in fade-in flex flex-col gap-5 duration-300">
      ...
      <div className="border-t border-zinc-800 pt-4">
        <button
          onClick={onDisconnect}
          className="flex w-full items-center justify-center gap-2 rounded-lg border border-rose-500/30 bg-rose-500/10 px-4 py-2.5 text-sm font-medium text-rose-400 transition-all hover:border-rose-500/50 hover:bg-rose-500/20 hover:text-rose-300 active:scale-[0.98]"
        >
          <svg className="h-4 w-4" fill="none" stroke="currentColor" viewBox="0 0 24 24">
            <path
              strokeLinecap="round"
