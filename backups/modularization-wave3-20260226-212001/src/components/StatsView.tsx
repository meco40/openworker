...
type StatsTab = 'overview' | 'logs' | 'sessions';
              ...
              <div className="grid grid-cols-1 gap-4 md:grid-cols-3">
                <div className="rounded-xl border border-zinc-800 bg-zinc-900/50 p-5 shadow-lg">
                  ...
                  <div className="mt-2 text-3xl font-black text-white">
                    {formatNumber(data.sessionLens?.totalSessions ?? 0)}
                  </div>
                </div>
                <div className="rounded-xl border border-zinc-800 bg-zinc-900/50 p-5 shadow-lg">
                  <div className="text-[10px] font-black tracking-widest text-zinc-500 uppercase">
                  ...
                  <div className="mt-2 text-3xl font-black text-white">
                    {formatNumber(data.sessionLens?.byChannel.length ?? 0)}
                  </div>
                </div>
                <div className="rounded-xl border border-zinc-800 bg-zinc-900/50 p-5 shadow-lg">
                  <div className="text-[10px] font-black tracking-widest text-zinc-500 uppercase">
                  ...
                  <div className="mt-2 text-3xl font-black text-white">
                    {formatNumber(data.sessionLens?.topSessions.length ?? 0)}
                  </div>
                </div>
              </div>
              ...
              {data.sessionLens && (
                <div className="grid grid-cols-1 gap-6 lg:grid-cols-2">
                  <div className="rounded-xl border border-zinc-800 bg-zinc-900/50 p-6 shadow-lg">
                    ...
                    {data.sessionLens.topSessions.length === 0 ? (
                      ...
                      <div className="max-h-[280px] overflow-y-auto">
                        <table className="w-full text-xs">
                          ...
                          <tbody>
                            {data.sessionLens.topSessions.map((session) => (
                  ...
                  <div className="rounded-xl border border-zinc-800 bg-zinc-900/50 p-6 shadow-lg">
                    ...
                    {data.sessionLens.byChannel.length === 0 ? (
                      <div className="text-[10px] font-black text-zinc-600 uppercase">
                        No channel data found.
                      </div>
                    ) : (
                      <div className="space-y-2">
                        {data.sessionLens.byChannel.map((entry) => {
                          const width =
                            data.sessionLens && data.sessionLens.totalSessions > 0
                              ? (entry.count / data.sessionLens.totalSessions) * 100
                              : 0;
                          return (
                            <div
