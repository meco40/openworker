...
## Erste Schritte
1. **Onboarding**: Starten Sie den Terminal-Wizard, um die Systemumgebung zu prüfen.
2. **API-Key**: Stellen Sie sicher, dass Ihr Gemini API Key in der Umgebung hinterlegt ist.
...
- Mitglieder einladen.
- Die Auslastung Ihrer Teams überwachen.

## Worker-Nodes deployen
