...
- Purpose: Verbindliche Regeln fuer agentische Aenderungen im Bereich Automation.
- Scope: "src/server/automation/**", "app/api/master/reminders/**".
...
1. tests/unit/master/master-notes-reminders-cron.test.ts
