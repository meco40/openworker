# Tasks Agent Contract

## Metadata

- Purpose: Verbindliche Regeln fuer agentische Aenderungen im Bereich Tasks.
- Scope: "app/api/tasks/**", "src/server/tasks/**".
...
1. tests/integration/mission-control/tasks-route-workspaces.test.ts
