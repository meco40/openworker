...
- Purpose: Verbindliche Regeln fuer agentische Aenderungen im Bereich Memory.
- Scope: "app/api/memory/**", "src/server/memory/**", "src/core/memory/\*\*".
...
1. tests/integration/memory/memory-route.test.ts
