# Core API Agent Contract

## Metadata

- Purpose: Verbindliche Regeln fuer agentische Aenderungen im Bereich Core API.
- Scope: "app/api/**", "src/server/**", "src/lib/db/\*\*".
...
1. tests/contract/public-api.contract.test.ts
