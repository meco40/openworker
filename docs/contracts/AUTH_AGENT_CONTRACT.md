...
- Purpose: Verbindliche Regeln fuer agentische Aenderungen im Bereich Auth.
- Scope: "auth.ts", "app/api/auth/**", "src/server/auth/**".
...
1. tests/integration/channels/omnichannel-security.contract.test.ts
