# ClawHub Agent Contract

## Metadata

- Purpose: Verbindliche Regeln fuer agentische Aenderungen im Bereich ClawHub.
- Scope: "src/server/clawhub/\*\*".
...
1. tests/unit/clawhub/clawhub-service.test.ts
