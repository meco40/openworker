...
- Purpose: Verbindliche Regeln fuer agentische Aenderungen im Bereich Session.
- Scope: "app/api/channels/state/**", "src/server/channels/**".
...
1. tests/integration/persistent-chat-session-v2.contract.test.ts
