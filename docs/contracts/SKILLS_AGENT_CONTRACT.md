...
- Purpose: Verbindliche Regeln fuer agentische Aenderungen im Bereich Skills.
- Scope: "src/server/skills/**", "src/skills/**".
...
1. tests/unit/skills/skills-registry.test.ts
