...
| ---------------------------- | ----------------------------------------------------------------------- | ------------------------------------- | -------------------------------------------------- |
| `readJson` + Error Handling  | `useOpsInstances`, `useOpsNodes`, `useOpsSessions`                      | `src/modules/ops/hooks/http.ts`       | Shared Helper anlegen, lokale Duplikate entfernen  |
...
| 5    | ✅     | Shared HTTP-Helper angelegt: `src/modules/ops/hooks/http.ts`; `useOpsInstances/useOpsNodes/useOpsSessions` darauf umgestellt                                                                                                                                                       |
