...
- **[docs/MEMORY_SYSTEM.md](MEMORY_SYSTEM.md)**
- **[docs/OMNICHANNEL_GATEWAY_SYSTEM.md](OMNICHANNEL_GATEWAY_SYSTEM.md)**
...
Bei Widerspruechen zwischen aktiver Doku und Archiv gilt immer `docs/` (ohne `docs/archive/`).
